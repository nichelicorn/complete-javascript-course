...
// √ 3. Use the 'calcTips' function we wrote before (no need to repeat) to calculate tips and total values (bill + tip) for every bill value in the bills array. Use a for loop to perform the 10 calculations!
...
function calcTipsAndTotals(array) {
  // calculate the tip and total for each value in an array
  // use a for loop
  // use the calcTip function
  let tip, total;

  for (let i = 0; i <= array.length; i++) {
    // console.log(array[i]);
    tip = calcTips(array[i]);
    tips4.push(tip);
...
calcTipsAndTotals(bills4);

console.log("bills >", bills4);
console.log("calculated tips >", tips4);
console.log("calculated totals >", totals4);
...
function calcAverage(array) {
  ...
  for (let i = 0; i < array.length; i++) {
    ...
    average = grandTotal / divisor;
  }

  console.log(`grandTotal: ${grandTotal} and the divisor: ${divisor};`)
